			...
			<div class="balance-box">
				...
				<div class="ContenedorColumna">
					<input type="number" max="99999999" id="txtDniCliente"
						name="txtDniCliente" placeholder="Ingrese su Dni..." required
						class="input-uniforme" required> <select id="txtProvincia"
						name="txtProvincia" onchange="actualizarLocalidades()" required
						class="input-uniforme">
						...
						%>
					</select> <select id="txtLocalidad" name="txtLocalidad" required
						class="input-uniforme">
				...
				<div class="ContenedorColumna">
					...
					<input type="text" id="txtNacionalidad" name="txtNacionalidad"
						...
						class="input-uniforme"> <select id="ddlSexo"
						name="tiposexo" required class="input-uniforme">
				...
				<div class="ContenedorColumna">
					...
					<input type="date" id="txtFechaNacimiento"
						name="txtFechaNacimiento" required class="input-uniforme">
				...
				<div class="ContenedorColumna">
					<input type="text" id="txtApellido" name="txtApellido"
						...
						class="input-uniforme"> <input type="text"
