...
public class Movimiento {
	...
	private Cuenta nroCuenta_movimiento;
	...
	public Cuenta getNroCuenta_movimiento() {
		return nroCuenta_movimiento;
	}

	public void setNroCuenta_movimiento(Cuenta nroCuenta_movimiento) {
		this.nroCuenta_movimiento = nroCuenta_movimiento;
	}
	...
	public void setId_tipoMovimiento(TipoMovimiento id_tipoMovimiento) {
		this.id_tipoMovimiento = id_tipoMovimiento;
	}
